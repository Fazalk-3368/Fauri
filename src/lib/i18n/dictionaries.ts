...
export const en = {
  ...
  auth: {
    ...
    codeOrLink: 'If the email has a link instead of a code, open it and you will be signed in.',
    codeSentTo: 'We sent a 6 digit code to',
    code: 'Verification code',
    verifyAction: 'Verify and continue',
    wrongEmail: 'Use a different email',
    codeTooShort: 'The code is 6 digits',
  ...
  map: {
    ...
    denied: 'Location permission denied. Enter your address manually or allow location in your browser.',
